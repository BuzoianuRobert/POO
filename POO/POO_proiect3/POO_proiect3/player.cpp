...
Player::Player(int x, int y, int health, int damage, int speed, string symbol, string name, int lives, int sanity)
...
Inventory<Item>& Player::getInventory(){ return backpack; }
